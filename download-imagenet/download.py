...
# https://github.com/JudyYe/zero-shot-gcn/blob/master/src/tools/download_image.py
...
def download(vid_file):
    ...
    for i in range(len(vid_list)):
        ...
        try:
            urllib.request.urlretrieve(url_acc, tar_file)
...
def parse_arg():
    ...
    parser.add_argument('--save_dir', type=str, default='/HDD1/sung/dataset/imagenet_21k',
                        help='path to save images')
    parser.add_argument('--user', type=str,
                        help='your username', default='hogili89')
    parser.add_argument('--key', type=str,
                        help='your access key', default='7873b6d844b0a416e6b847ecb73e3ef84d54d3b8')
...
if __name__ == '__main__':
    name = 'all'
    list_file = os.path.join('./wnid_imagenet.txt')
    download(list_file)
